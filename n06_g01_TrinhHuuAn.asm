...
#3. Dia chi cua con tro
	...
	j	menu
#4. Viet ham thuc hien copy 2 con tro xau ki tu
case_2:
	bne	$v0, 2, case_3
	li	$v0, 4
	la	$a0, mess2.1
...
case_4:
	...
	syscall	
	j	menu
#6. Viet ham tinh toan bo luong bo nho da cap phat
case_5:
...
malloc:  
	...
	andi	$t0, $t8, 0x03		# Kiem tra xem dia chi dau tien co chia het cho 4 hay khong
...
memoryCalculate:
	...
	la	$t1, Sys_TheTopOfFree	# Lay dia chi con tro den dinh cua vung nho tu do
